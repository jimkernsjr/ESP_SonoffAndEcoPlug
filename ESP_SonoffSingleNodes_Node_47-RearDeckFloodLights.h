//////////Include file for Node 51 - Rear Deck Lights////////////////////////////
////Jim 12/2016
...
//Different Motion floodlights need different timings...This is not a motion detector so we can ignore these
...
#define VERSION "Sonoff V1.2-RDeckLts"          // this value can be queried as device 3 --Limit 28 chars
...
#define OTAname "ESP8266-Sonoff-N47"       //enable OTA code upgrades --Max Chars about 20 & no _ or the port wont show!
